...
class ActionMenu extends React.Component {
    constructor (props) {
        ...
        this.state = {
            ...
            marginLeftPaint: window.innerWidth
        };
    ...
    componentDidMount () {
        ...
        this.handleResize();  // rogic-moibile
    ...
    shouldComponentUpdate (newProps, newState) {
        ...
        return newState.isOpen !== this.state.isOpen ||
            ...
            newState.marginLeft !== this.state.marginLeft ||  // rogic-mobile
            newState.marginTop !== this.state.marginTop ||
            newState.marginLeftPaint !== this.state.marginLeftPaint;
    }
    ...
    handleResize = () => {  //rogic-mobile
        this.setState({
            ...
            marginTop: window.innerHeight - (5 * 16 + 4.5 * 16 + 90),  // header: 3rem, filter: 4.5rem, 가장 오른쪽 정렬
            marginLeftPaint: window.innerWidth - 230
        });
    };
    render () {
        const {
        ...
        return (
            <div
                ...
                style={{  // rogic-mobile
                    marginLeft: isMobileUpload ? `${this.state.marginLeft}px` :
                        isMobilePaint ? `${this.state.marginLeftPaint}px` : null,
                    marginTop: (isMobileUpload || isMobilePaint) ? `${this.state.marginTop}px`: null
                }}  
            >
                <button
                                ...
                                <div key={`${tooltipId}-${keyId}`}>
                                    <button
                                        ...
                                        className={classNames(styles.moreButton, {
                                            [styles.button]: !this.props.isMobileAction,
...
ActionMenu.propTypes = {
    ...
    isMobileUpload: PropTypes.bool,
    isMobilePaint: PropTypes.bool
};
