...
class SoundEditor extends React.Component {
    ...
    componentDidMount () {
        ...
        window.addEventListener('resize', this.handleResize);  // rogic-mobile
    }
    ...
    shouldComponentUpdate (nextProps, nextState) {  // rogic-mobile
        return (
            ...
            nextState.copyBuffer !== this.state.copyBuffer ||
            nextState.chunkLevels !== this.state.chunkLevels ||
            nextState.playhead !== this.state.playhead ||
            nextState.trimStart !== this.state.trimStart ||
            nextState.trimEnd !== this.state.trimEnd
        );
    }
    ...
    render () {
        ...
        return (
            <SoundEditorComponent
                ...
                onContainerClick={this.handleContainerMouseDown}
